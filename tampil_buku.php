...
<body>
    ...
    <h1>Data Buku</h1>
        <form action="tampil_kelas.php" method="POST">
            <input type="text" name="cari" class="form-control" placeholder="Mau Cari Buku Apa?">
        </form>
        <table>
    <thead>
        <tr>
  ...
  <tbody>
      ...
      ?>
        <tr>
            ...
            <td>
            <a href="ubah_buku.php?id_buku=<?=$data_buku['id_buku']?>" class="btn btn-primary">Update</a>
